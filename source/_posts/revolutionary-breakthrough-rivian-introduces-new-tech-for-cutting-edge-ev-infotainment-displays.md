---
title: "Revolutionary Breakthrough: Rivian Introduces New Tech for Cutting-Edge EV Infotainment Displays"
date: 2024-08-29T01:13:40.614Z
updated: 2024-08-30T01:13:40.614Z
tags:
  - cutting-edge
categories:
  - tech
...
## Revolutionary Breakthrough: Rivian Introduces New Tech for Cutting-Edge EV Infotainment Displays

We have some bad news if you're the proud owner of the Rivian R1T electric truck or R1S SUV. This week, Rivian released a minor software update that broke the infotainment display, and there's no easy fix in sight.
 ...
 For example, in many electric vehicles (including both Rivian models), the infotainment display gives you access to the climate controls and heater. Thankfully, [Electrek reports](https://electrek.co/2023/11/14/rivian-software-update-bricks-infotainment-system-fix-not-obvious/) that owners can change those with the app until Rivian can fix the failed software update. The excellent news is that backup cameras, door locks, and turn signals still work, so you can drive the vehicle without worry.

 Here's the latest update from Rivian, _"The issue impacts the infotainment system. In most cases, the rest of the vehicle systems are still operational. A vehicle reset or sleep cycle will not solve the issue. We are validating the best options to address the issue for the impacted vehicles. Our customer support team is prioritizing support for our customers related to this issue. Thank you."_ 
 ...
 Source: [Reddit](https://www.reddit.com/r/Rivian/comments/17usikn/202342%5Fota%5Fupdate%5Fissue/)
